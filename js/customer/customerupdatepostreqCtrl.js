resourceApp.controller('customerupdatepostreqCtrl',["$scope","$rootScope","$state","$stateParams","RAService",function($scope,$rootScope,$state,$stateParams,RAService){
    ...
    $scope.back = function (stage) {
      ...
      $scope.companyid = function(){
        ...
        $scope.yearsOfExperience = ["0","1 years", "2 years", "3 years","4 years", "5 years", "6 years","7 years", "8 years", "9 years","10 years","11 years"];
        $scope.monthsOfExperience = ["0","1 months", "2 months", "3 months","4 months", "5 months", " 6 months","7 months", "8 months", "9 months","10 months","11 months"];
        $scope.edit = function(){
