resourceApp.config(
        ['$stateProvider', '$urlRouterProvider', '$locationProvider', '$httpProvider', function ($stateProvider, $urlRouterProvider, $locationProvider, $httpProvider) {
			...
			.state('customer.vendorpostedresource',{
				url:'/vendorpostedresource',
				templateUrl:'partials/vendor/vendorpostedresource.html',
				cache: false,
				controller:'vendorpostedresourceCtrl'
